package leetCodeDailyTasks.twoBestNonOverlappingEvents;

import java.util.Arrays;
import java.util.Scanner;

public class TwoBestNonOverlappingEventsApp {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            events[i] = new int[]{scanner.nextInt(), scanner.nextInt()};

        }
        scanner.close();
        System.out.println(new TwoBestNonOverlappingEventsApp().maxTwoEvents(events));
    }
}
